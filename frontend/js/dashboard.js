...
async function loadDashboardData() {
    try {
        ...
        document.getElementById("presenzeOggi").textContent = stats.presenzeOggi || 0;
        document.getElementById("totaleDipendenti").textContent = stats.totaleDipendenti || 0;
        document.getElementById("ancoraPresenti").textContent = stats.ancoraPresenti || 0;
        document.getElementById("richiesteInAttesa").textContent = stats.richiesteInAttesa || 0;
        ...
        const statsMensiliResponse = await fetch("http://localhost:3000/api/presenze/statistiche");
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (user.nome && user.cognome) {
        ...
        `;
        header.querySelector('.flex.items-center.space-x-4').insertBefore(userInfo, header.querySelector('button'));
    }
